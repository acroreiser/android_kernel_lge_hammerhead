...
static inline u64 mul_u64_u32_shr_bore(u64 a, u32 mul, unsigned int shift)
{
	u32 ah, al;
	u64 ret;
	al = a;
...
static inline u64 scale_slice(u64 delta, struct sched_entity *se) {
	return mul_u64_u32_shr_bore(delta, prio_to_wmult[se->burst_score], 22);
}
	      ...
	      unsigned long delta_exec)
{
	...
	curr->vruntime += max(1ULL, delta_exec_weighted);
#else // !CONFIG_SCHED_BORE
